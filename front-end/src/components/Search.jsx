...
return(
    ...
    <button onClick={(e)=>setShowCalender(!showCalender)}
     className="px-4 py-2 w-48 text-left text-gray-500 focus:outline-none"
     >
     {date[0].startDate && date[0].endDate && date[0].startDate.getTime()!==date[0].endDate.getTime() ? `${date[0].startDate.toLocaleDateString()}-${date[0].endDate.toDateString()}`: "Add dates"
   ...
   <button onClick={handleSearch} className="p-3 text-white bg-pink-500 rounded-full hover:bg-pink-600">
