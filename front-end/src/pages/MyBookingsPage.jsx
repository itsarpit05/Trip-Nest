...
const MyBookingsPage = () => {
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl">
            ...
            {notification && (
                <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-md relative mb-8" role="alert">
                    <p>{notification}</p>
                </div>
            )}
            {error && (
                 <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md relative mb-8" role="alert">
                    <p>{error}</p>
                </div>
            )}
            ...
            {bookings.length > 0 ? (
                <div className="space-y-6">
                    {bookings.map(booking => (
                        <div key={booking._id} className="bg-white p-4 rounded-xl shadow-md border">
                            <div className="flex flex-col md:flex-row gap-5">
                                <img 
                                    src={booking.property.images[0] || 'https://placehold.co/600x400/E2E8F0/AAAAAA?text=No+Image'} 
                                    ...
                                    <div className="mt-4 pt-4 border-t">
                                        <div className="flex justify-between items-center">
                                            <div>
                                                ...
                                                <p className="text-md font-bold text-pink-600">{new Date(booking.checkin).toLocaleDateString()}</p>
                                            </div>
                                            <div>
